...
//#define MY_DEVICE_ID  "Vid_13C6&Pid_E405"	//Change this number (along with the corresponding VID/PID in the 
											//microcontroller firmware, and in the driver installation .INF 
											//file) before moving the design into production.
#define MY_DEVICE_ID  "Vid_13C6&Pid_E406"	
...
#pragma endregion
	...
	volatile unsigned char DEV_1_StateByte = 0xFF;	//atomic variable, used for sharing small amount of data between threads.
	volatile unsigned char DEV_2_StateByte = 0xFF;	//atomic variable, used for sharing small amount of data between threads.
	volatile unsigned char DEV_3_StateByte = 0xFF;	//atomic variable, used for sharing small amount of data between threads.
	volatile unsigned char DEV_4_StateByte = 0xFF;	//atomic variable, used for sharing small amount of data between threads.
	volatile unsigned char DEV_5_StateByte = 0xFF;	//atomic variable, used for sharing small amount of data between threads.
	volatile unsigned char DEV_6_StateByte = 0xFF;	//atomic variable, used for sharing small amount of data between threads.
	...
	public:
		Form1(void)	//Constructed function that gets executed when the Form is created.
		{
			...
			if (CheckIfPresentAndGetUSBDevicePath())	//Check and make sure at least one device with matching VID/PID is attached
			{
				...
				if (ErrorStatus == ERROR_SUCCESS)
				{
					...
					if (BoolStatus == TRUE)
					{
						...
						DEV_1_State_label->Text = "DEV_1_Power : Unknown";
						DEV_1_State_label->Enabled = TRUE;
						DEV_2_State_label->Text = "DEV_2_Power : Unknown";
						DEV_2_State_label->Enabled = TRUE;
						DEV_3_State_label->Text = "DEV_3_Power : Unknown";
						DEV_3_State_label->Enabled = TRUE;
						DEV_4_State_label->Text = "DEV_4_Power : Unknown";
						DEV_4_State_label->Enabled = TRUE;
						DEV_5_State_label->Text = "DEV_5_Power : Unknown";
						DEV_5_State_label->Enabled = TRUE;

						DEV_1_ON_btn->Enabled = TRUE;
						DEV_2_ON_btn->Enabled = TRUE;
						DEV_3_ON_btn->Enabled = TRUE;
						DEV_4_ON_btn->Enabled = TRUE;
						DEV_5_ON_btn->Enabled = TRUE;

						DEV_1_OFF_btn->Enabled = TRUE;
						DEV_2_OFF_btn->Enabled = TRUE;
						DEV_3_OFF_btn->Enabled = TRUE;
						DEV_4_OFF_btn->Enabled = TRUE;
						DEV_5_OFF_btn->Enabled = TRUE;

						DEV_6_State_label->Text = "DEV_6_State : Unknown";
						DEV_6_State_label->Enabled = TRUE;
						DEV_6_OFF_btn->Enabled = TRUE;
						DEV_6_ON_btn->Enabled = TRUE;
					}
				}
			}
			else	//Device must not be connected (or not programmed with correct firmware)
			{
				...
				DEV_1_State_label->Text = "DEV_1_Power : Power Off";
				DEV_1_State_label->Enabled = FALSE;
				DEV_2_State_label->Text = "DEV_2_Power : Power Off";
				DEV_2_State_label->Enabled = FALSE;
				DEV_3_State_label->Text = "DEV_3_Power : Power Off";
				DEV_3_State_label->Enabled = FALSE;
				DEV_4_State_label->Text = "DEV_4_Power : Power Off";
				DEV_4_State_label->Enabled = FALSE;
				DEV_5_State_label->Text = "DEV_5_Power : Power Off";
				DEV_5_State_label->Enabled = FALSE;

				DEV_1_ON_btn->Enabled = FALSE;
				DEV_2_ON_btn->Enabled = FALSE;
				DEV_3_ON_btn->Enabled = FALSE;
				DEV_4_ON_btn->Enabled = FALSE;
				DEV_5_ON_btn->Enabled = FALSE;

				DEV_1_OFF_btn->Enabled = FALSE;
				DEV_2_OFF_btn->Enabled = FALSE;
				DEV_3_OFF_btn->Enabled = FALSE;
				DEV_4_OFF_btn->Enabled = FALSE;
				DEV_5_OFF_btn->Enabled = FALSE;

				DEV_6_State_label->Text = "DEV_6_State : Power Off";
				DEV_6_State_label->Enabled = FALSE;
				DEV_6_OFF_btn->Enabled = FALSE;
				DEV_6_ON_btn->Enabled = FALSE;
	...
	private: System::Windows::Forms::Button^  DEV_1_ON_btn;
	private: System::Windows::Forms::Label^  DEV_1_State_label;
	...
	private: System::Windows::Forms::Button^  DEV_2_ON_btn;
	private: System::Windows::Forms::Button^  DEV_3_ON_btn;
	private: System::Windows::Forms::Button^  DEV_4_ON_btn;
	private: System::Windows::Forms::Button^  DEV_5_ON_btn;
	private: System::Windows::Forms::Button^  DEV_5_OFF_btn;





	private: System::Windows::Forms::Button^  DEV_4_OFF_btn;

	private: System::Windows::Forms::Button^  DEV_3_OFF_btn;

	private: System::Windows::Forms::Button^  DEV_2_OFF_btn;

	private: System::Windows::Forms::Button^  DEV_1_OFF_btn;
	private: System::Windows::Forms::Label^  DEV_2_State_label;
	private: System::Windows::Forms::Label^  DEV_3_State_label;
	private: System::Windows::Forms::Label^  DEV_4_State_label;
	private: System::Windows::Forms::Label^  DEV_5_State_label;
private: System::Windows::Forms::Button^  DEV_6_ON_btn;
private: System::Windows::Forms::Button^  DEV_6_OFF_btn;


private: System::Windows::Forms::Label^  DEV_6_State_label;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->DEV_1_ON_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_1_State_label = (gcnew System::Windows::Forms::Label());
			...
			this->DEV_2_ON_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_3_ON_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_4_ON_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_5_ON_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_5_OFF_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_4_OFF_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_3_OFF_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_2_OFF_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_1_OFF_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_2_State_label = (gcnew System::Windows::Forms::Label());
			this->DEV_3_State_label = (gcnew System::Windows::Forms::Label());
			this->DEV_4_State_label = (gcnew System::Windows::Forms::Label());
			this->DEV_5_State_label = (gcnew System::Windows::Forms::Label());
			this->DEV_6_ON_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_6_OFF_btn = (gcnew System::Windows::Forms::Button());
			this->DEV_6_State_label = (gcnew System::Windows::Forms::Label());
			this->SuspendLayout();
			// 
			// StatusBox_lbl
			// 
			this->StatusBox_lbl->AutoSize = true;
			this->StatusBox_lbl->Location = System::Drawing::Point(369, 14);
			this->StatusBox_lbl->Name = L"StatusBox_lbl";
			this->StatusBox_lbl->Size = System::Drawing::Size(40, 12);
			...
			this->StatusBox_txtbx->Location = System::Drawing::Point(14, 11);
			this->StatusBox_txtbx->Name = L"StatusBox_txtbx";
			this->StatusBox_txtbx->ReadOnly = true;
			this->StatusBox_txtbx->Size = System::Drawing::Size(347, 21);
			this->StatusBox_txtbx->TabIndex = 18;
			// 
			// DEV_1_ON_btn
			// 
			this->DEV_1_ON_btn->Enabled = false;
			this->DEV_1_ON_btn->Location = System::Drawing::Point(14, 51);
			this->DEV_1_ON_btn->Name = L"DEV_1_ON_btn";
			this->DEV_1_ON_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_1_ON_btn->TabIndex = 20;
			this->DEV_1_ON_btn->Text = L"DEV_1_ON";
			this->DEV_1_ON_btn->UseVisualStyleBackColor = true;
			this->DEV_1_ON_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_1_ON_btn_Click);
			// 
			// DEV_1_State_label
			// 
			this->DEV_1_State_label->AutoSize = true;
			this->DEV_1_State_label->Enabled = false;
			this->DEV_1_State_label->Location = System::Drawing::Point(341, 55);
			this->DEV_1_State_label->Name = L"DEV_1_State_label";
			this->DEV_1_State_label->Size = System::Drawing::Size(147, 12);
			this->DEV_1_State_label->TabIndex = 21;
			this->DEV_1_State_label->Text = L"DEV_1_Power : Unknown";
			// 
			// GUIUpdateTimer
			// 
			...
			// DEV_2_ON_btn
			// 
			this->DEV_2_ON_btn->Enabled = false;
			this->DEV_2_ON_btn->Location = System::Drawing::Point(14, 83);
			this->DEV_2_ON_btn->Name = L"DEV_2_ON_btn";
			this->DEV_2_ON_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_2_ON_btn->TabIndex = 22;
			this->DEV_2_ON_btn->Text = L"DEV_2_ON";
			this->DEV_2_ON_btn->UseVisualStyleBackColor = true;
			this->DEV_2_ON_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_2_ON_btn_Click);
			// 
			// DEV_3_ON_btn
			// 
			this->DEV_3_ON_btn->Enabled = false;
			this->DEV_3_ON_btn->Location = System::Drawing::Point(14, 115);
			this->DEV_3_ON_btn->Name = L"DEV_3_ON_btn";
			this->DEV_3_ON_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_3_ON_btn->TabIndex = 23;
			this->DEV_3_ON_btn->Text = L"DEV_3_ON";
			this->DEV_3_ON_btn->UseVisualStyleBackColor = true;
			this->DEV_3_ON_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_3_ON_btn_Click);
			// 
			// DEV_4_ON_btn
			// 
			this->DEV_4_ON_btn->Enabled = false;
			this->DEV_4_ON_btn->Location = System::Drawing::Point(14, 147);
			this->DEV_4_ON_btn->Name = L"DEV_4_ON_btn";
			this->DEV_4_ON_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_4_ON_btn->TabIndex = 24;
			this->DEV_4_ON_btn->Text = L"DEV_4_ON";
			this->DEV_4_ON_btn->UseVisualStyleBackColor = true;
			this->DEV_4_ON_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_4_ON_btn_Click);
			// 
			// DEV_5_ON_btn
			// 
			this->DEV_5_ON_btn->Enabled = false;
			this->DEV_5_ON_btn->Location = System::Drawing::Point(14, 179);
			this->DEV_5_ON_btn->Name = L"DEV_5_ON_btn";
			this->DEV_5_ON_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_5_ON_btn->TabIndex = 25;
			this->DEV_5_ON_btn->Text = L"DEV_5_ON";
			this->DEV_5_ON_btn->UseVisualStyleBackColor = true;
			this->DEV_5_ON_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_5_ON_btn_Click);
			// 
			// DEV_5_OFF_btn
			// 
			this->DEV_5_OFF_btn->Enabled = false;
			this->DEV_5_OFF_btn->Location = System::Drawing::Point(133, 179);
			this->DEV_5_OFF_btn->Name = L"DEV_5_OFF_btn";
			this->DEV_5_OFF_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_5_OFF_btn->TabIndex = 30;
			this->DEV_5_OFF_btn->Text = L"DEV_5_OFF";
			this->DEV_5_OFF_btn->UseVisualStyleBackColor = true;
			this->DEV_5_OFF_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_5_OFF_btn_Click);
			// 
			// DEV_4_OFF_btn
			// 
			this->DEV_4_OFF_btn->Enabled = false;
			this->DEV_4_OFF_btn->Location = System::Drawing::Point(133, 147);
			this->DEV_4_OFF_btn->Name = L"DEV_4_OFF_btn";
			this->DEV_4_OFF_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_4_OFF_btn->TabIndex = 29;
			this->DEV_4_OFF_btn->Text = L"DEV_4_OFF";
			this->DEV_4_OFF_btn->UseVisualStyleBackColor = true;
			this->DEV_4_OFF_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_4_OFF_btn_Click);
			// 
			// DEV_3_OFF_btn
			// 
			this->DEV_3_OFF_btn->Enabled = false;
			this->DEV_3_OFF_btn->Location = System::Drawing::Point(133, 115);
			this->DEV_3_OFF_btn->Name = L"DEV_3_OFF_btn";
			this->DEV_3_OFF_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_3_OFF_btn->TabIndex = 28;
			this->DEV_3_OFF_btn->Text = L"DEV_3_OFF";
			this->DEV_3_OFF_btn->UseVisualStyleBackColor = true;
			this->DEV_3_OFF_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_3_OFF_btn_Click);
			// 
			// DEV_2_OFF_btn
			// 
			this->DEV_2_OFF_btn->Enabled = false;
			this->DEV_2_OFF_btn->Location = System::Drawing::Point(133, 83);
			this->DEV_2_OFF_btn->Name = L"DEV_2_OFF_btn";
			this->DEV_2_OFF_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_2_OFF_btn->TabIndex = 27;
			this->DEV_2_OFF_btn->Text = L"DEV_2_OFF";
			this->DEV_2_OFF_btn->UseVisualStyleBackColor = true;
			this->DEV_2_OFF_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_2_OFF_btn_Click);
			// 
			// DEV_1_OFF_btn
			// 
			this->DEV_1_OFF_btn->Enabled = false;
			this->DEV_1_OFF_btn->Location = System::Drawing::Point(133, 51);
			this->DEV_1_OFF_btn->Name = L"DEV_1_OFF_btn";
			this->DEV_1_OFF_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_1_OFF_btn->TabIndex = 26;
			this->DEV_1_OFF_btn->Text = L"DEV_1_OFF";
			this->DEV_1_OFF_btn->UseVisualStyleBackColor = true;
			this->DEV_1_OFF_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_1_OFF_btn_Click);
			// 
			// DEV_2_State_label
			// 
			this->DEV_2_State_label->AutoSize = true;
			this->DEV_2_State_label->Enabled = false;
			this->DEV_2_State_label->Location = System::Drawing::Point(341, 87);
			this->DEV_2_State_label->Name = L"DEV_2_State_label";
			this->DEV_2_State_label->Size = System::Drawing::Size(147, 12);
			this->DEV_2_State_label->TabIndex = 31;
			this->DEV_2_State_label->Text = L"DEV_2_Power : Unknown";
			// 
			// DEV_3_State_label
			// 
			this->DEV_3_State_label->AutoSize = true;
			this->DEV_3_State_label->Enabled = false;
			this->DEV_3_State_label->Location = System::Drawing::Point(341, 119);
			this->DEV_3_State_label->Name = L"DEV_3_State_label";
			this->DEV_3_State_label->Size = System::Drawing::Size(147, 12);
			this->DEV_3_State_label->TabIndex = 32;
			this->DEV_3_State_label->Text = L"DEV_3_Power : Unknown";
			// 
			// DEV_4_State_label
			// 
			this->DEV_4_State_label->AutoSize = true;
			this->DEV_4_State_label->Enabled = false;
			this->DEV_4_State_label->Location = System::Drawing::Point(341, 151);
			this->DEV_4_State_label->Name = L"DEV_4_State_label";
			this->DEV_4_State_label->Size = System::Drawing::Size(147, 12);
			this->DEV_4_State_label->TabIndex = 33;
			this->DEV_4_State_label->Text = L"DEV_4_Power : Unknown";
			// 
			// DEV_5_State_label
			// 
			this->DEV_5_State_label->AutoSize = true;
			this->DEV_5_State_label->Enabled = false;
			this->DEV_5_State_label->Location = System::Drawing::Point(341, 183);
			this->DEV_5_State_label->Name = L"DEV_5_State_label";
			this->DEV_5_State_label->Size = System::Drawing::Size(147, 12);
			this->DEV_5_State_label->TabIndex = 34;
			this->DEV_5_State_label->Text = L"DEV_5_Power : Unknown";
			// 
			// DEV_6_ON_btn
			// 
			this->DEV_6_ON_btn->Enabled = false;
			this->DEV_6_ON_btn->Location = System::Drawing::Point(14, 211);
			this->DEV_6_ON_btn->Name = L"DEV_6_ON_btn";
			this->DEV_6_ON_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_6_ON_btn->TabIndex = 36;
			this->DEV_6_ON_btn->Text = L"DEV_6_ON";
			this->DEV_6_ON_btn->UseVisualStyleBackColor = true;
			this->DEV_6_ON_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_6_ON_btn_Click);
			// 
			// DEV_6_OFF_btn
			// 
			this->DEV_6_OFF_btn->Enabled = false;
			this->DEV_6_OFF_btn->Location = System::Drawing::Point(133, 211);
			this->DEV_6_OFF_btn->Name = L"DEV_6_OFF_btn";
			this->DEV_6_OFF_btn->Size = System::Drawing::Size(113, 21);
			this->DEV_6_OFF_btn->TabIndex = 35;
			this->DEV_6_OFF_btn->Text = L"DEV_6_OFF";
			this->DEV_6_OFF_btn->UseVisualStyleBackColor = true;
			this->DEV_6_OFF_btn->Click += gcnew System::EventHandler(this, &Form1::DEV_6_OFF_btn_Click);
			// 
			// DEV_6_State_label
			// 
			this->DEV_6_State_label->AutoSize = true;
			this->DEV_6_State_label->Enabled = false;
			this->DEV_6_State_label->Location = System::Drawing::Point(341, 215);
			this->DEV_6_State_label->Name = L"DEV_6_State_label";
			this->DEV_6_State_label->Size = System::Drawing::Size(147, 12);
			this->DEV_6_State_label->TabIndex = 37;
			this->DEV_6_State_label->Text = L"DEV_6_Power : Unknown";
			// 
			// Form1
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(7, 12);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(516, 253);
			this->Controls->Add(this->DEV_6_State_label);
			this->Controls->Add(this->DEV_6_ON_btn);
			this->Controls->Add(this->DEV_6_OFF_btn);
			this->Controls->Add(this->DEV_5_State_label);
			this->Controls->Add(this->DEV_4_State_label);
			this->Controls->Add(this->DEV_3_State_label);
			this->Controls->Add(this->DEV_2_State_label);
			this->Controls->Add(this->DEV_5_OFF_btn);
			this->Controls->Add(this->DEV_4_OFF_btn);
			this->Controls->Add(this->DEV_3_OFF_btn);
			this->Controls->Add(this->DEV_2_OFF_btn);
			this->Controls->Add(this->DEV_1_OFF_btn);
			this->Controls->Add(this->DEV_5_ON_btn);
			this->Controls->Add(this->DEV_4_ON_btn);
			this->Controls->Add(this->DEV_3_ON_btn);
			this->Controls->Add(this->DEV_2_ON_btn);
			this->Controls->Add(this->DEV_1_State_label);
			this->Controls->Add(this->DEV_1_ON_btn);
...
#pragma endregion
		...
		if (m.Msg == WM_DEVICECHANGE)
		{
			if (((int)m.WParam == DBT_DEVICEARRIVAL) || ((int)m.WParam == DBT_DEVICEREMOVEPENDING) || ((int)m.WParam == DBT_DEVICEREMOVECOMPLETE) || ((int)m.WParam == DBT_CONFIGCHANGED))
			{
					...
					if (AttachedState == FALSE)
					{
						...
						if (ErrorStatus == ERROR_SUCCESS)
						{
							...
							if (BoolStatus == TRUE)
							{
								...
								DEV_6_State_label->Text = "DEV_6_Power : Unknown";
								DEV_6_State_label->Enabled = TRUE;
								DEV_6_OFF_btn->Enabled = TRUE;
								DEV_6_ON_btn->Enabled = TRUE;
							}
				...
				else	//Device must not be connected (or not programmed with correct firmware)
				{
					...
					DEV_6_State_label->Text = "DEV_6_Power : Power Off";
					DEV_6_State_label->Enabled = FALSE;
					DEV_6_OFF_btn->Enabled = FALSE;
					DEV_6_ON_btn->Enabled = FALSE;
				...
				if (Status == TRUE)
				{
					...
					if (Status == TRUE)
					{
						...
						if (INBuffer[0] == 0x81) //0x81 is the get pushbutton state command
						{
							...
							DEV_1_StateByte = INBuffer[1];	//Byte 1 contains the pushbutton state.  Byte 0 is 
							DEV_2_StateByte = INBuffer[2];	//Byte 1 contains the pushbutton state.  Byte 0 is 
							DEV_3_StateByte = INBuffer[3];	//Byte 1 contains the pushbutton state.  Byte 0 is 
							DEV_4_StateByte = INBuffer[4];	//Byte 1 contains the pushbutton state.  Byte 0 is 
							DEV_5_StateByte = INBuffer[5];	//Byte 1 contains the pushbutton state.  Byte 0 is 
							DEV_6_StateByte = INBuffer[6];	//Byte 1 contains the pushbutton state.  Byte 0 is 
					...
					else
					{
						...
						DEV_1_StateByte = 0xFF;	//Not valid pressed/not pressed value
						DEV_2_StateByte = 0xFF;	//Not valid pressed/not pressed value
						DEV_3_StateByte = 0xFF;	//Not valid pressed/not pressed value
						DEV_4_StateByte = 0xFF;	//Not valid pressed/not pressed value
						DEV_5_StateByte = 0xFF;	//Not valid pressed/not pressed value
						DEV_6_StateByte = 0xFF;	//Not valid pressed/not pressed value
					}
				}//if(Status == TRUE)
				else
				{
					...
					//state, so lets force the PushbuttonStateByte to an invalid value,
					//so the GUIUpdateTimer can portray the pushbutton state as unknown.
					DEV_1_StateByte = 0xFF;	//Not valid pressed or not pressed value.  Value "unknown"
					DEV_2_StateByte = 0xFF;	//Not valid pressed or not pressed value.  Value "unknown"
					DEV_3_StateByte = 0xFF;	//Not valid pressed or not pressed value.  Value "unknown"
					DEV_4_StateByte = 0xFF;	//Not valid pressed or not pressed value.  Value "unknown"
					DEV_5_StateByte = 0xFF;	//Not valid pressed or not pressed value.  Value "unknown"
					DEV_6_StateByte = 0xFF;	//Not valid pressed or not pressed value.  Value "unknown"
	...
	private: System::Void GUIUpdateTimer_Tick(System::Object^  sender, System::EventArgs^  e) {
		...
		else
		{
			//////////////////////////////////////////////////
			// DEV1
			if (DEV_1_StateByte == 0x00)
			{
				DEV_1_State_label->Text = "DEV_1_Power : OFF";
			}
			else if (DEV_1_StateByte == 0x01)
			{
				DEV_1_State_label->Text = "DEV_1_Power : ON";
			}
			else
			{
			...
			//////////////////////////////////////////////////
			// DEV2
			if (DEV_2_StateByte == 0x00)
			{
				DEV_2_State_label->Text = "DEV_2_Power : OFF";
			}
			else if (DEV_2_StateByte == 0x01)
			{
				DEV_2_State_label->Text = "DEV_2_Power : ON";
			}
			else
			{
				//The firmware responded with an unexpected value
			...
			//////////////////////////////////////////////////
			// DEV3
			if (DEV_3_StateByte == 0x00)
			{
				DEV_3_State_label->Text = "DEV_3_Power : OFF";
			}
			else if (DEV_3_StateByte == 0x01)
			{
				DEV_3_State_label->Text = "DEV_3_Power : ON";
			}
			else
			{
				//The firmware responded with an unexpected value
			...
			//////////////////////////////////////////////////
			// DEV4
			if (DEV_4_StateByte == 0x00)
			{
				DEV_4_State_label->Text = "DEV_4_Power : OFF";
			}
			else if (DEV_4_StateByte == 0x01)
			{
				DEV_4_State_label->Text = "DEV_4_Power : ON";
			}
			else
			{
				//The firmware responded with an unexpected value
			...
			//////////////////////////////////////////////////
			// DEV5
			if (DEV_5_StateByte == 0x00)
			{
				DEV_5_State_label->Text = "DEV_5_Power : OFF";
			}
			else if (DEV_5_StateByte == 0x01)
			{
				DEV_5_State_label->Text = "DEV_5_Power : ON";
			}
			else
			{
				//The firmware responded with an unexpected value
			...
			//////////////////////////////////////////////////
			// Tap Power
			if (DEV_6_StateByte == 0x00)
			{
				DEV_6_State_label->Text = "DEV_6_Power : OFF";
			}
			else if (DEV_6_StateByte == 0x01)
			{
				DEV_6_State_label->Text = "DEV_6_Power : ON";
			}
			else
			{
				//The firmware responded with an unexpected value
	...
	private: System::Void DEV_1_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;

		//Prepare a USB OUT data packet to send to the device firmware
		OUTBuffer[0] = 0x8A;	//0x80 in byte 0 position is the "Toggle LED" command in the firmware
		OUTBuffer[1] = 0x01;

		//Now send the USB packet data in the OUTBuffer[] to the device firmware.
		WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x01, &OUTBuffer[0], 2, &LengthTransferred, NULL);

	}//private: System::Void DEV_1_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {

	private: System::Void DEV_2_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;

		//Prepare a USB OUT data packet to send to the device firmware
		OUTBuffer[0] = 0x8B;	//0x80 in byte 0 position is the "Toggle LED" command in the firmware
		OUTBuffer[1] = 0x01;

		//Now send the USB packet data in the OUTBuffer[] to the device firmware.
		WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x01, &OUTBuffer[0], 2, &LengthTransferred, NULL);
	}
	private: System::Void DEV_3_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;

		//Prepare a USB OUT data packet to send to the device firmware
		OUTBuffer[0] = 0x8C;	//0x80 in byte 0 position is the "Toggle LED" command in the firmware
		OUTBuffer[1] = 0x01;

		//Now send the USB packet data in the OUTBuffer[] to the device firmware.
		WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x01, &OUTBuffer[0], 2, &LengthTransferred, NULL);
	}
	private: System::Void DEV_4_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;

		//Prepare a USB OUT data packet to send to the device firmware
		OUTBuffer[0] = 0x8D;	//0x80 in byte 0 position is the "Toggle LED" command in the firmware
		OUTBuffer[1] = 0x01;

		//Now send the USB packet data in the OUTBuffer[] to the device firmware.
		WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x01, &OUTBuffer[0], 2, &LengthTransferred, NULL);
	}
	private: System::Void DEV_5_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;

		//Prepare a USB OUT data packet to send to the device firmware
		OUTBuffer[0] = 0x8E;	//0x80 in byte 0 position is the "Toggle LED" command in the firmware
		OUTBuffer[1] = 0x01;

		//Now send the USB packet data in the OUTBuffer[] to the device firmware.
		WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x01, &OUTBuffer[0], 2, &LengthTransferred, NULL);
	}
	private: System::Void DEV_1_OFF_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;
	...
	private: System::Void DEV_2_OFF_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;
	...
	private: System::Void DEV_3_OFF_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;
	...
	private: System::Void DEV_4_OFF_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;
	...
	private: System::Void DEV_5_OFF_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;
	...
	private: System::Void DEV_6_OFF_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;

		//Prepare a USB OUT data packet to send to the device firmware
		OUTBuffer[0] = 0x8F;	//0x80 in byte 0 position is the "Toggle LED" command in the firmware
		OUTBuffer[1] = 0x00;

		//Now send the USB packet data in the OUTBuffer[] to the device firmware.
		WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x01, &OUTBuffer[0], 2, &LengthTransferred, NULL);
	}
	private: System::Void DEV_6_ON_btn_Click(System::Object^  sender, System::EventArgs^  e) {
		unsigned char OUTBuffer[64];
		ULONG LengthTransferred;
